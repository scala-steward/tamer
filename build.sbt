...
val V = new {
  ...
  val `embedded-kafka`                 = "4.2.0"
  val `embedded-kafka-schema-registry` = "8.2.0"
  val http4s                           = "0.23.33"
  val jackson                          = "2.21.1"
  val `jackson-annotations`            = "2.21"
  val `json-schema`                    = "1.14.4"
  val `jsoniter-scala`                 = "2.38.9"
  val kafka                            = "4.2.0"
  val logback                          = "1.5.32"
...
lazy val D = new {
  ...
  val `doobie-core`    = "org.typelevel"         %% "doobie-core"   % V.doobie
  val `doobie-hikari`  = "org.typelevel"         %% "doobie-hikari" % V.doobie
  val `embedded-kafka` =
  ...
  val `jackson-annotations`        = "com.fasterxml.jackson.core"             % "jackson-annotations"        % V.`jackson-annotations`
